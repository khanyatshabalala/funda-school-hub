    ...
    return (
      <div className="max-w-2xl">
        ...
        <Card className="p-8 bg-gradient-to-br from-primary to-[oklch(0.25_0.08_240)] text-primary-foreground border-0">
          ...
          <div className="mt-6 p-3 rounded-lg bg-white/10 text-sm">This month you're supporting: <span className="font-semibold">Khayelitsha Comprehensive School</span></div>
          <div className="mt-6 space-y-2">
            <Button onClick={() => toast.info("Card payments coming soon. Real Stripe integration next iteration.")} className="w-full bg-accent text-accent-foreground hover:bg-accent/90 h-11">Upgrade with Card</Button>
