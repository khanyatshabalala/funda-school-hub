...
export const Route = createFileRoute("/about")({
  component: About,
  head: () => ({ meta: [{ title: "About Funda — South African School Management" }, { name: "description", content: "Why we built Funda: every parent and every school in one app, focused on the South African education system." }]}),
});
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-4 py-16 max-w-3xl">
        <div className="text-sm text-accent font-medium mb-2">ABOUT FUNDA</div>
        <h1 className="text-4xl font-bold tracking-tight">Built for South African schools.</h1>
        <div className="mt-8 space-y-5 text-muted-foreground leading-relaxed">
          <p>South African parents juggle WhatsApp groups, paper notes and confusing portals. Funda — "to learn" in isiZulu — replaces that chaos with one app that connects every parent to every school.</p>
